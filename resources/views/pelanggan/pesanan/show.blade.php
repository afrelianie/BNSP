        ...
        <div class="row">
            ...
            <form action="">
                ...
                <div class="inputBox">
                    ...
                    <h4 class="text-muted fas fas fa-map-marker-alt mr-1 mr-1">&nbsp; &nbsp;{{ $pesanan->destinasi[0]->nama_destinasi }}</h4>
                </div>
                <div class="inputBox">
                    <h3>Harga</h3>
                    <h4 class="text-muted fas fa-dollar-sign mr-1">&nbsp; &nbsp;{{ $pesanan->destinasi[0]->harga }}</h4>
                </div>
                <div class="inputBox">
                    <h3>Kode Pesanan</h3>
